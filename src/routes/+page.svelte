...
<div class="form-box">
    <div class="form" style="width: min(40rem,100%);">
        ...
        <form method="POST" use:enhance>
            <Field name="email" type="email" ph="ejemplo@mail.com" 
                label="Correo electrónico" warning={form?.email && form.missing} 
                fb={emailError}
            />
            <Field name="password" type="password" ph="Ingrese su contraseña" 
                label="Contraseña"
